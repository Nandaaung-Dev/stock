            ...
            <div class="hidden lg:block">
                ...
                <ul>
                    ...
                    <li class="mb-2 rounded hover:shadow hover:bg-gray-800">
                        <a href="{{ route('items.index')}}" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
                    ...
                    <li class="mb-2 rounded hover:shadow hover:bg-gray-800">
                        <a href="{{ route('categories.index') }}" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
