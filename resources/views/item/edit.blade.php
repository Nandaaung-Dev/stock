    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="w-full">
            ...
            <div class="w-1/2">
                ...
                <input type="text" name="latitude" value="{{$item->latitude}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="w-1/2">
                <label class="block text-sm font-bold text-gray-700 mb-2" for="title">longtitude</label>
                <input type="text" name="longtitude" value="{{$item->longtitude}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            </div>
